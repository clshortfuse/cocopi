 ...
 */
export function createCocopiLogger(vscode) {
...
export function logCodexResponseEventDiagnostics(logger, debugLevel, event, context = {}) {
  ...
  if (debugLevel === "payloads") {
    logDebugJsonPayload(logger, formatDiagnosticsPrefix("Codex stream event payload.", contextFields), event);
  }
 ...
 */
function logDebugJsonPayload(logger, prefix, value) {
