  ...
  return {
    ...
    async provideLanguageModelChatResponse(model, messages, requestOptions, progress, token) {
      ...
      try {
        ...
        const commentaryProgress = createLanguageModelReasoningProgressReporter(progress, vscode, true, "Commentary");
        /**
         * @param {string} callId
        ...
        if (commentaryTextDeltas === 0 && completedCommentaryOutputText) {
          ...
          commentaryProgress.report(completedCommentaryOutputText, {
            id: "cocopi-commentary:completed",
            metadata: { openai_phase: "commentary" }
          });
          progressSummary.textDeltas += 1;
