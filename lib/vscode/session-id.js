...
const COCOPI_SESSION_ID_PATTERN = /^cocopi-(?:chat|language-model|autocomplete)-[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/u;

/**
 * @param {"chat" | "language-model" | "autocomplete"} scope
 */
