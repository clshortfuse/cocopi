...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .status-card, .control-card, .feature-panel, .feature-card, .usage-panel, .replacement-panel, .links { background: var(--vscode-editorWidget-background); border: 1px solid var(--vscode-editorWidget-border); border-radius: 14px; box-shadow: 0 8px 24px rgb(0 0 0 / 0.14); }
